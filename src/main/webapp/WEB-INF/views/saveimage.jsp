			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<div id="myTabContent" class="tab-content">
						<form action="upload_image.action" name="myform" method="post" class="form" enctype="multipart/form-data">
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>图片</label> <input type="file" name="image" class="form-control"  />
								</div>
							</div>
							<div>
