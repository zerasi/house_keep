			...
			<div class="box_1">
				...
				<div class="boxCenterList clearfix" id='history_list'>
					<c:forEach items="${hotList}" var="goods">
						<ul class="clearfix">
							<li class="goodsimg"><a
									href="detail.action?id=${goods.goodsid }" target="_blank"><img
									src="<%=path %>/showImg.action?imgurl=${goods.image}" alt="${goods.goodsname }" class="B_blue" />
							</a></li>
							<li><a href="detail.action?id=${goods.goodsid }"
					...
					<c:forEach items="${articleList}" var="article">
						<tr>
							<td><a title="${article.title }"
								   href="read.action?id=${article.articleid }"
