...
public class UsersAction extends BaseAction {
	...
	// 准备添加数据
	@RequestMapping("users_createUsers.action")
	public String createUsers() {
		return "admin/addusers";
	}

	// 添加数据
	@RequestMapping("users_addUsers.action")
	public String addUsers(Users users) {
		this.usersService.insertUsers(users);
		return "redirect:/users_createUsers.action";
	}

	// 通过主键删除数据
	@RequestMapping("users_deleteUsers.action")
	public String deleteUsers(String id) {
		this.usersService.deleteUsers(id);
		return "redirect:/users_getAllUsers.action";
	}

	// 批量删除数据
	@RequestMapping("users_deleteUsersByIds.action")
	...
	// 更新数据
	@RequestMapping("users_updateUsers.action")
	...
	// 显示全部数据
	@RequestMapping("users_getAllUsers.action")
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("users_queryUsersByCond.action")
	...
	// 按主键查询数据
	@RequestMapping("users_getUsersById.action")
