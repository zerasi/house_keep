...
public class OrdersAction extends BaseAction {
	...
	// 准备添加数据
	@RequestMapping("orders_createOrders.action")
	...
	// 添加数据
	@RequestMapping("orders_addOrders.action")
	public String addOrders(Orders orders) {
		this.ordersService.insertOrders(orders);
		return "redirect:/orders_createOrders.action";
	}

	// 通过主键删除数据
	@RequestMapping("orders_deleteOrders.action")
	public String deleteOrders(String id) {
		this.ordersService.deleteOrders(id);
		return "redirect:/orders_getAllOrders.action";
	}

	// 批量删除数据
	@RequestMapping("orders_deleteOrdersByIds.action")
	...
	// 更新数据
	@RequestMapping("orders_updateOrders.action")
	...
	// 显示全部数据
	@RequestMapping("orders_getAllOrders.action")
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("orders_queryOrdersByCond.action")
	...
	// 按主键查询数据
	@RequestMapping("orders_getOrdersById.action")
