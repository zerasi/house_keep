...
public class CateAction extends BaseAction {
	...
	// 准备添加数据
	@RequestMapping("cate_createCate.action")
	public String createCate() {
		return "admin/addcate";
	}

	// 添加数据
	@RequestMapping("cate_addCate.action")
	public String addCate(Cate cate) {
		this.cateService.insertCate(cate);
		return "redirect:/cate_createCate.action";
	}

	// 通过主键删除数据
	@RequestMapping("cate_deleteCate.action")
	public String deleteCate(String id) {
		this.cateService.deleteCate(id);
		return "redirect:/cate_getAllCate.action";
	}

	// 批量删除数据
	@RequestMapping("cate_deleteCateByIds.action")
	...
	// 更新数据
	@RequestMapping("cate_updateCate.action")
	...
	// 显示全部数据
	@RequestMapping("cate_getAllCate.action")
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("cate_queryCateByCond.action")
	...
	// 按主键查询数据
	@RequestMapping("cate_getCateById.action")
