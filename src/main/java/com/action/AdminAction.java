...
public class AdminAction extends BaseAction {
	...
	// 修改密码
	@RequestMapping("admineditpwd.action")
	...
	// 准备添加数据
	@RequestMapping("admincreateAdmin.action")
	public String createAdmin() {
		return "admin/addadmin";
	}

	// 添加数据
	@RequestMapping("adminaddAdmin.action")
	public String addAdmin(Admin admin) {
		admin.setAddtime(VeDate.getStringDateShort());
		this.adminService.insertAdmin(admin);
		return "redirect:/admincreateAdmin.action";
	}

	// 通过主键删除数据
	@RequestMapping("admindeleteAdmin.action")
	public String deleteAdmin(String id) {
		this.adminService.deleteAdmin(id);
		return "redirect:/admingetAllAdmin.action";
	}

	// 通过主键删除数据
	@RequestMapping("adminloginPage.action")
	public String adminLogin(String id) {
		return "admin/index";
	}

	// 批量删除数据
	@RequestMapping("admindeleteAdminByIds.action")
	...
	// 更新数据
	@RequestMapping("adminupdateAdmin.action")
	...
	// 显示全部数据
	@RequestMapping("admingetAllAdmin.action")
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("adminqueryAdminByCond.action")
	...
	// 按主键查询数据
	@RequestMapping("admingetAdminById.action")
