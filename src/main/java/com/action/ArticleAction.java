...
public class ArticleAction extends BaseAction {
	...
	// 准备添加数据
	@RequestMapping("article_createArticle.action")
	public String createArticle() {
		return "admin/addarticle";
	}

	// 添加数据
	@RequestMapping("article_addArticle.action")
	public String addArticle(Article article) {
		article.setAddtime(VeDate.getStringDateShort());
		article.setHits("0");
		this.articleService.insertArticle(article);
		return "redirect:/article_createArticle.action";
	}

	// 通过主键删除数据
	@RequestMapping("article_deleteArticle.action")
	public String deleteArticle(String id) {
		this.articleService.deleteArticle(id);
		return "redirect:/article_getAllArticle.action";
	}

	// 批量删除数据
	@RequestMapping("article_deleteArticleByIds.action")
	...
	// 更新数据
	@RequestMapping("article_updateArticle.action")
	...
	// 显示全部数据
	@RequestMapping("article_getAllArticle.action")
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("article_queryArticleByCond.action")
	...
	// 按主键查询数据
	@RequestMapping("article_getArticleById.action")
