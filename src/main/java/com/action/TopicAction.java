...
public class TopicAction extends BaseAction {
	...
	// 准备添加数据
	@RequestMapping("topic_createTopic.action")
	...
	// 添加数据
	@RequestMapping("topic_addTopic.action")
	public String addTopic(Topic topic) {
		...
		return "redirect:/topic_createTopic.action";
	}

	// 通过主键删除数据
	@RequestMapping("topic_deleteTopic.action")
	public String deleteTopic(String id) {
		this.topicService.deleteTopic(id);
		return "redirect:/topic_getAllTopic.action";
	}

	// 批量删除数据
	@RequestMapping("topic_deleteTopicByIds.action")
	...
	// 更新数据
	@RequestMapping("topic_updateTopic.action")
	...
	// 显示全部数据
	@RequestMapping("topic_getAllTopic.action")
	...
	// 按条件查询数据 (模糊查询)
	@RequestMapping("topic_queryTopicByCond.action")
	...
	// 按主键查询数据
	@RequestMapping("topic_getTopicById.action")
